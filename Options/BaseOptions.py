...
parser.add_argument('--canonical_encoder_input_size', default=18 * 512, type=int, help='Number of input neurons')
parser.add_argument('--canonical_encoder_output_size', default=18 * 512, type=int, help='Number of output neurons')
parser.add_argument('--canonical_encoder_hidden_size', default=18 * 512, type=int, help='Number of hidden neurons')
