...
parser.add_argument("--train_dataset_path", type=str, default='/home/zottang//working_dir/DATA')
parser.add_argument("--test_dataset_path", type=str, default='/home/zottang//working_dir/DATA')
