...
class FCTFG(Dataset):
    def __init__(self, opts):
        ...
        self.video_path = os.path.join(opts.Dataset, 'video')
        ...
        self.vtransform = vtramsforms.ToTensor()

        ######## Audio
        self.audio_path = os.path.join(opts.Dataset, 'audio')
...
if __name__ == "__main__":
    ...
    print(src.shape, tgts[0].shape, sgram.shape)
